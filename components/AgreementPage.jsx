...
const SECTIONS = [
  ...
  ['9. PAYMENT, RESERVATION FEES, AND CANCELLATIONS', 'Booking fees, reservation fees, concierge fees, and administrative fees are generally non-refundable unless otherwise determined by Company policy. The Company reserves the right to refuse or cancel bookings at its discretion.'],
