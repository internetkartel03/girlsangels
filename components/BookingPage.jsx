...
const SERVICE_META = {
  ...
  pool:      { description: 'Energetic entertainers and social hosts for luxury pool parties, private cabanas, and upscale events.', badge: 'Bachelor Event' },
  companion: { description: 'Sophisticated companionship for upscale dinners, nightlife experiences, casino outings, and exclusive social events.', badge: 'Ultimate Discretion' }
};
